...
const Contact = () => {
  ...
  return (
    <section
    class="ezy__contact14  py-14 md:py-24 relative  overflow-hidden "
  >
            ...
            <div class="grid grid-cols-12 gap-4">
              <div class="col-span-12 md:col-span-6">
                <div class="mb-3 mt-2">
                  <input
                    ...
                    class="py-4 min-h-48 text-black border-b-2  bg-transparent rounded-none focus:border-blue-500 focus:shadow-none w-full  outline-none transition duration-200 ease-in-out"
                  />
                </div>
              </div>
              <div class="col-span-12 md:col-span-6">
              ...
              <div class="col-span-12">
                <div class="mt-4 text-end md:text-start">
                  <button
                    class="border rounded-md border-gray-300 border-opacity-25 py-3 px-4 bg-black text-white dark:bg-transparent hover:bg-[#28303B] dark:hover:bg-transparent hover:text-white dark:hover:text-[#4E5762] transition duration-200 ease-in-out"
                  >
