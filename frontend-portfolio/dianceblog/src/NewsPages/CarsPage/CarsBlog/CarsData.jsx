...
const CarsData = () => {
  const { data } = useFetchCars("https://newsapi.org/v2/everything?q=apple&from=2025-06-11&to=2025-06-11&sortBy=popularity&apiKey=d2257e24d6d14ed49332a15d9b59e7be")
