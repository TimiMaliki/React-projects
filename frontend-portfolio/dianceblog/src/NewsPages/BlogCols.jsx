...
const BlogCols = () => {
 const [data, setData] = useState(null)
   useEffect(()=>{
        fetch("https://newsapi.org/v2/top-headlines?sources=techcrunch&pageSize=3&apiKey=d2257e24d6d14ed49332a15d9b59e7be")
        .then((res)=>{
             return res.json()
  ...
  return (
    <div className="w-full mt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mt-4">
        ...
        <div className="second-grid flex justify-center gap-3 business">
          <div className="divider w-1 h-full bg-slate-800"></div>
          <div>
           {data && <DataOne data={data}/>} 
           </div>
        </div>
