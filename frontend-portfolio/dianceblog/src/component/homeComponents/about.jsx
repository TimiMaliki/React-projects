        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-lg md:text-xl lg:text-2xl text-center text-gray-800 leading-relaxed">
              ...
              knowledge they need to share their voice with the world. Whether
              you're just starting your blogging journey or looking to grow your
              existing platform, Diance-Blog offers in-depth guides, the latest
              insights, and practical strategies to help you succeed. Our
              mission is to simplify the blogging process, spark creativity, and
              build a supportive community where your ideas can thrive and make
              an impact.
            </p>
          </div>
          {/* Mission Section */}
          <div className="text-center mt-6">
            <div className="max-w-4xl mx-auto px-4">
              ...
              <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed text-center">
                ...
                journey easier, smarter, and more rewarding. By combining
                cutting-edge tech insights with content creation strategies, we
                empower bloggers to build authentic voices, grow meaningful
                communities, and thrive in a fast-changing digital world.
                Whether you're writing about code, culture, or creativity, our
                goal is to be the foundation that supports your vision, passion,
          ...
          <div className="text-center mt-10">
            <h2 className="text-xl mb-4 font-extrabold">Meet the Authors</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-8 overflow-x-auto sm:overflow-visible py-4 px-2 sm:px-0">
              ...
              <div className="flex flex-col items-center gap-4 min-w-[180px]">
                ...
                <img
                  src={authorTwo}
                  alt=""
                  className="bg-center object-cover rounded-full w-full h-full"
                />
                <div>
