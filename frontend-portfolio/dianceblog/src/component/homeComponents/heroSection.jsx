const Hero = () => {
    return ( 
      ...
      />
      <h1
        className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold text-white z-10 text-center px-5"
      >
      "Every blog post is a stepping stone toward your masterpiece."
      </h1>
    
      <h2
        className="text-base sm:text-lg md:text-xl lg:text-2xl text-white z-10 mt-4 text-center px-4"
      >
