  ...
  return (
    <div id="art">
      <div className="container mx-auto h-full pt-20">
        <h2 className="will-fade">Movies</h2>
        ...
        <div className="masked-container">
          <h2 className="will-fade">Cinematic Perfection</h2>
          <div id="masked-content">
            <h3>Book Your Seat, Enjoy the Show</h3>
            <p>
              This isn’t just about watching a movie — it’s about experiencing
              world-class theatres, seamless booking, and unforgettable moments
              on the big screen.
            </p>
          </div>
        </div>
