...
{blog?.articles?.length > 0 &&
  blog.articles.map((blog, index) => (
    <div className="col-span-6 md:col-span-3 lg:col-span-2 mb-10" key={index}>
      <article className="rounded-2xl overflow-hidden shadow-lg dark:shadow-none border border-gray-100  transition-all duration-300 group hover:shadow-xl hover:-translate-y-1">
        {/* Image */}
