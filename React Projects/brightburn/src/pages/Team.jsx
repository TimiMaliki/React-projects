...
const Team = () => {
  return (
    <section className="w-full py-16 sm:py-20 bg-white" id="team">
      <div className="px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-extrabold mb-4 text-black">
        ...
        <div className="grid gap-8 sm:gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={index}
              className="w-full bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-2xl transition"
            >
              ...
              <div className="p-4 sm:p-6">
                <p className="text-black text-base sm:text-lg">{member.bio}</p>
                <div className="mt-4 flex space-x-4">
                  {member.socials.map((social, idx) => (
                    <a
                      key={idx}
                      href={social.href}
                      className="text-black text-xl sm:text-2xl hover:text-red-600"
