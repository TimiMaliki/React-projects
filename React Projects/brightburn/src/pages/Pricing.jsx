const PricingSection = () => {
  return (
    <section className="w-full py-16 sm:py-20 bg-white" id="pricing">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-black max-w-2xl mx-auto text-base sm:text-xl font-bold">
        ...
        {/* Website Builds */}
        <div className="grid gap-8 sm:gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-16">
          {/* Single Page */}
          <div className="bg-gray-50 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
              Single Page Website
            </h3>
            <p className="text-3xl sm:text-4xl font-extrabold text-red-600 mb-4">$299</p>
            <p className="text-black mb-6 text-base sm:text-lg">
              Clean, fast, and effective one-page website.
            </p>
            <ul className="text-black space-y-2 mb-6 text-base sm:text-lg">
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            ...
            <p className="text-3xl sm:text-4xl font-extrabold text-red-600 mb-4">$799</p>
            <p className="text-black mb-6 text-base sm:text-lg">
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            ...
            <p className="text-3xl sm:text-4xl font-extrabold text-red-600 mb-4">$1,499</p>
            <p className="text-black mb-6 text-base sm:text-lg">
        ...
        <div className="grid gap-8 sm:gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {/* Hosting */}
          <div className="bg-gray-100 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
              Website Hosting
            </h3>
            <p className="text-2xl sm:text-3xl font-extrabold text-red-600 mb-4">$19/mo</p>
            <p className="text-black mb-6 text-base sm:text-lg">
          ...
          <div className="bg-gray-100 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            ...
            <p className="text-2xl sm:text-3xl font-extrabold text-red-600 mb-4">$49/mo</p>
            <p className="text-black mb-6 text-base sm:text-lg">
          ...
          <div className="bg-gray-100 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200 hover:shadow-xl transition">
            ...
            <p className="text-2xl sm:text-3xl font-extrabold text-red-600 mb-4">$499/year</p>
            <p className="text-black mb-6 text-base sm:text-lg">
