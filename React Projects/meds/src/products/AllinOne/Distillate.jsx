...
import "swiper/css";
import { Distileflavors } from "../../constant/index";
  ...
  return (
    ...
    <div className="absolute inset-0 -z-10">
      ...
      <div className="text-center mb-12 relative z-10">
        <h1 className="text-4xl md:text-6xl font-bold text-white tracking-widest drop-shadow-lg" style={{
        color: videoStyle.ui,
      }}>
          DISTILLATE
        </h1>
